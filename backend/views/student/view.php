          ...
          <div class="card">
            <div class="card-header p-2">
              <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a class="nav-link" href="#settings" data-toggle="tab">To'lovlar</a></li>
              </ul>
            </div><!-- /.card-header -->
            <div class="card-body">
            ...
            <div class="card">
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td>
                       <?php foreach($model->studentGroups as $student):?>
                      <?=$student->group->lesson_days; ?>
                       <br><br>
                       <?php endforeach;?>
                    </td>
                    <td>
                       <?php foreach($model->studentGroups as $student):?>
                      <?=$student->group->lesson_time; ?>
                       <br><br>
                       <?php endforeach;?>
                    </td>
                  </tr>
                    ...
                    <tr>
                        <td>
                            <?php foreach($model->paymentGroups as $payment):?>
                              <span class="badge badge-success"><?=$payment->payment_amount; ?></span>
                                <br><br>
                            <?php endforeach;?>
                        </td>
                        <td>
